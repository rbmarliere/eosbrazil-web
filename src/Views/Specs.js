                ...
                <div className="container">
                    <div className="row mt-10 justify-content-center">
                        <div className="col-xs-10 col-md-8">
                            ...
                            <div className="card mb-5">
                                <div className="card-body">
                                    <h5 className="card-title mt-2 mb-2">Proxy servers</h5>
                                    <ul className="list-group list-group-flush">
                                        <li className="list-group-item text-black-50">t2.large burstable performance instances</li>
                                    </ul>
                                    <p className="card-text mt-2 mb-2">We have already made a reasonable investment in a few bare metal servers in order to move off of AWS into a data center when possible and have more direct control over scaling</p>
                                    <h5 className="card-subtitle mt-2 mb-2">Ubuntu Linux</h5>
                                    <ul className="list-group list-group-flush">
                                    ...
                                    <h5 className="card-subtitle mt-2 mb-2">iMac Pro</h5>
                                    <ul className="list-group list-group-flush">
                            ...
                            <div className="card mb-5">
                                <div className="card-body">
                                    <h5 className="card-title mt-2 mb-2">Storage</h5>
                            ...
                            <div className="card mb-5">
                                <div className="card-body">
                                    <h5 className="card-title mt-2 mb-2">Security</h5>
