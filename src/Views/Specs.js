                        ...
                        <div className="col-xs-10 col-md-8 text-justify">
                            ...
                            <div className="card mb-2">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">We are still very hesitant about the idea of block producers providing IPFS storage, but we are tentatively going to have a single d2 instance (somewhere from 12-48 TB in size) for the purpose of providing rudimentary storage. Anything further will require us to move to bare metal servers in order to implement the high speed hardware required to keep I/O performance at a workable level. This is of course not a priority at the moment since the feature is still to be implemented in the EOS protocol.</p>
                                </div>
                            </div>
